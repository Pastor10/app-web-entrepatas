...
@Component({
  selector: 'app-tickets-derivados',
  templateUrl: './tickets-derivados.component.html'
})
export class TicketsDerivadosComponent implements OnInit {
  ...
  public search() {
    ...
    this.reporteService.ticketsDerivados(this.reporteQuery).subscribe(
      data => {

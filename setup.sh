...
then    
    ...
    sed -i -e 's/localhost:9002/dev.f7ws.solucionesfps.pe/g' /var/www/html/fps-app-web-entrepatas/main.js
...
then    
    ...
    echo "Setting up project $PROFILE"
    echo "backend for qa"
    sed -i -e 's/localhost:9002/qa.f7ws.solucionesfps.pe/g' /var/www/html/fps-app-web-entrepatas/main.js
    echo "filestorage for dev"
    # sed -i -e 's/35.229.116.96:8585/35.229.116.96:8585/g' /var/www/html/app/main.*.js
    nginx -g 'daemon off;'
...
then
    ...
    sed -i -e 's/http:\/\/localhost:9002/https:\/\/f7.farmaciasperuanas.pe/g' /var/www/html/fps-app-web-entrepatas/main.js

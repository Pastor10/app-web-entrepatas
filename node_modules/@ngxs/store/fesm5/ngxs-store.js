...
import { NgZone, Injectable, Inject, PLATFORM_ID, InjectionToken, Optional, SkipSelf, ErrorHandler, Injector, NgModule, isDevMode, APP_BOOTSTRAP_LISTENER } from '@angular/core';
import { INITIAL_STATE_TOKEN, NgxsBootstrapper, memoize, isAngularInTestMode, NGXS_STATE_CONTEXT_FACTORY, NGXS_STATE_FACTORY, InitialState } from '@ngxs/store/internals';
import { isPlatformServer } from '@angular/common';
import { Observable, Subject, BehaviorSubject, forkJoin, of, throwError, EMPTY, from, ReplaySubject } from 'rxjs';
...
export { Action, Actions, InitState, NGXS_PLUGINS, NgxsModule, NgxsSimpleChange, NoopNgxsExecutionStrategy, Select, Selector, SelectorOptions, State, StateStream, StateToken, Store, UpdateState, actionMatcher, createSelector, ensureSelectorMetadata, ensureStoreMetadata, getActionTypeFromInstance, getSelectorMetadata, getStoreMetadata, getValue, ofAction, ofActionCanceled, ofActionCompleted, ofActionDispatched, ofActionErrored, ofActionSuccessful, setValue, OrderedSubject as ɵa, InternalActions as ɵb, ROOT_STATE_TOKEN as ɵe, FEATURE_STATE_TOKEN as ɵf, NG_TEST_MODE as ɵg, NG_DEV_MODE as ɵh, SELECTOR_META_KEY as ɵi, NgxsConfig as ɵj, NGXS_EXECUTION_STRATEGY as ɵk, NgxsRootModule as ɵl, StateFactory as ɵm, InternalDispatchedActionResults as ɵn, InternalDispatcher as ɵo, StateContextFactory as ɵp, InternalStateOperations as ɵq, PluginManager as ɵr, InternalNgxsExecutionStrategy as ɵs, ConfigValidator as ɵt, HostEnvironment as ɵu, SelectFactory as ɵv, LifecycleStateManager as ɵw, NgxsFeatureModule as ɵx, DispatchOutsideZoneNgxsExecutionStrategy as ɵy };
